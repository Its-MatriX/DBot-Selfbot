...
class HelpCog(commands.Cog):
    ...
    async def help__(self, ctx, command=None):
        ...
        if not command:
            inform = '>  **DBot `V1.19` - Список команд**\n> \n' + \
            ...
            pages = [
                        ...
                        '> `inftype` - **бесконечной написание сообщения**',
            ...
            if command == 'reaction_troll':
                ...
                resp = '> **gename**\n' + \
                    '> `Сгенерировать случайный никнейм, совмещая никнеймы двух случайных участников.`'

            elif command == 'inftype':
                resp = '> **inftype**\n' + \
                    '> `Будет бесконечно светиться индикатор о том, что вы печатаете. (оствновится, когда вы отправите сообщение)`'
                ...
                resp = '> **clear_all**\n' + \
                    '> `Отправить сообщение, содержащее 1000 новых строк (очень долго листается).`'
